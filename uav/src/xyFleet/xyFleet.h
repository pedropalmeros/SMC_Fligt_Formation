...
* \brief Class defining a PID
*/
class xyFleet : public ControlLaw {
  friend class ::xyFleet_impl;
...
public:
  ...
  * \param name name
  */
  xyFleet(const gui::LayoutPosition *position, std::string name);
  ...
  */
  void SetValues(float id, float a0, float a1, float a2, float vel, float ref_vel);
