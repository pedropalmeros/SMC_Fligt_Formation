...
xySMC_impl::xySMC_impl(xySMC *self, const LayoutPosition *position, string name) {
  ...
  beta = new DoubleSpinBox(reglages_groupbox->NewRow(), "beta", -10,10,0.01,0.000);
  alpha = new DoubleSpinBox(reglages_groupbox->NewRow(), "alpha",-10,10,0.01,0.000);
  rho = new DoubleSpinBox(reglages_groupbox->NewRow(),"rho",-10,10,0.01,0.000);

  satCtrl = new DoubleSpinBox(reglages_groupbox->NewRow(),"SatCtrl",-10,10,0.01,0.000);
  sclCtrl = new DoubleSpinBox(reglages_groupbox->NewRow(),"ScaleCtrl",-10,10,0.01,0.000);
